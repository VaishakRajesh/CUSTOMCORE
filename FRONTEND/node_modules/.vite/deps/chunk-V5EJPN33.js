...
function useAutocomplete(props) {
  ...
  const initialInputValue = React2.useRef(getInputValue(defaultValue, multiple, getOptionLabel)).current;
...
var Skeleton = React19.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(SkeletonRoot, {
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
...
var Tooltip = React20.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children = React20.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime18.jsx)("span", {
    children: childrenProp
  });
  ...
  return (0, import_jsx_runtime18.jsxs)(React20.Fragment, {
    children: [React20.cloneElement(children, childrenProps), (0, import_jsx_runtime18.jsx)(PopperSlot, {
      ...
      children: ({
        ...
        children: (0, import_jsx_runtime18.jsxs)(TooltipSlot, {
          ...tooltipSlotProps,
          children: [title, arrow2 ? (0, import_jsx_runtime18.jsx)(ArrowSlot, {
            ...arrowSlotProps
          }) : null]
        })
      })
...
//# sourceMappingURL=chunk-V5EJPN33.js.map
