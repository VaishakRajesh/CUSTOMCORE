        ...
        <div className={Styles.Body}>
            <div className={Styles.Head}>
                ...
                <div className={Styles.Select}>
                    ...
                    <Link to="/UserProfile"><Button sx={{ color: 'black', height: '40px', fontSize: '20px', borderRadius: '30px', border: '1px solid white', bgcolor: 'white' }}>Profile<PersonIcon /></Button></Link>
                </div>
            </div>
